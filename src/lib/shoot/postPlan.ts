...
export const MONTH1_POSTS: PlannedPost[] = [
  ...
  },
  {
    ...
    kpi: "プロフィールアクセス、保存率",
    note: "悩み→木の指輪という選択肢→着け心地→指輪・バングル・イヤーカフは金属不使用、ピアスは樹脂フックに変更できるので安心して使える（金属フック・イヤリングへの変更も可）→Creema誘導。",
  },
  {
    ref: "post-03",
    label: "#3 製作工程① 研磨",
  ...
  },
  {
    ...
    kpi: "プロフィールアクセス、保存率",
    note: "悩み提示→木の指輪を着ける手元→軽さ・温かさ→指輪は金属不使用、ピアスは樹脂フックに変更できるので安心して使える旨→プロフィールへ。",
  },
  {
    ref: "post-10",
    label: "#10 木婚式② 贈り方",
